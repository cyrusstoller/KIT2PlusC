    ...
    respond_to do |format|
      ...
      format.csv {
        csv_string = CSV.generate do |csv|
          csv << ["id", "participant_id", "confidence_discrete", "answer_discrete", "confidencewhy_discrete", 
                  "created_at", "updated_at", "ad_test"]
          @searches.each do |s|
            csv << [s.id, s.participant_id, s.confidence_discrete, s.answer_discrete, s.confidencewhy_discrete,
                    s.created_at, s.updated_at, s.ad_test]
          end
        end
  ...
  def nested_download
    ...
    respond_to do |format|
      ...
      format.csv {
        ...
        csv_string = CSV.generate do |csv|
          temp = ["id", "participant_id", "confidence_discrete", "answer_discrete", "confidencewhy_discrete",
                  "created_at", "updated_at", "ad_test"]
          ...
          csv << temp
          @searches.each do |s|
            temp = [s.id, s.participant_id, s.confidence_discrete, s.answer_discrete, s.confidencewhy_discrete,
                    s.created_at, s.updated_at, s.ad_test]
